        ...
        <li>
          <el-dropdown class="white font" trigger="click" placement="bottom" @command="handleCommand">
            ...
            <el-dropdown-menu slot="dropdown">
              ...
              <a href="https://gitee.com/cuihaiqi/mamahao.git" target="_blank">
...
export default {
  ...
  mounted(){
    ...
    if(sessionStorage.getItem('position')==2){
      this.position="普通管理员"
    };
    if(sessionStorage.getItem('position')==3){
      this.position="管理员"
    };
